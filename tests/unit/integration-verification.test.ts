...
describe('Story 1.4 Integration Verification', () => {
  ...
  describe('Complete Story 1.4 requirements verification', () => {
    it('should cover all 29 endpoints as specified in the story', () => {
      ...
      expect(Object.getOwnPropertyNames(Object.getPrototypeOf(client.returns))
        .filter(name => name !== 'constructor').length).toBe(1);
      
      // ReturnAPI: 8 endpoints
      expect(Object.getOwnPropertyNames(Object.getPrototypeOf(client.return))
        .filter(name => name !== 'constructor').length).toBe(8);
      
      // Quants: 2 endpoints
      expect(Object.getOwnPropertyNames(Object.getPrototypeOf(client.quants))
        .filter(name => name !== 'constructor').length).toBe(2);
    });
