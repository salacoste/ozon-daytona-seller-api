...
import type { GetCompensationReportRequest, GetDecompensationReportRequest, CreateDocumentB2BSalesReportRequest, GetFinanceProductsBuyoutRequest, FinanceTransactionListV3Request, FinanceTransactionTotalsV3Request } from "../../src/types/requests/finance.js";
import type { CreateReportResponse, CommonCreateReportResponse, CreateDocumentB2BSalesJSONReportResponse, GetFinanceProductsBuyoutResponse, FinanceTransactionListV3Response, FinanceTransactionTotalsV3Response } from "../../src/types/responses/finance.js";
...
describe("FinanceApi", () => {
  ...
  describe("createCompensationReport", () => {
    it("should call correct endpoint with request data", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/finance/compensation", request, undefined);
  ...
  describe("createDecompensationReport", () => {
    it("should call correct endpoint", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/finance/decompensation", request, undefined);
    });
  });
  ...
  describe("createDocumentB2BSalesReport", () => {
    it("should call correct endpoint", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/finance/document-b2b-sales", request, undefined);
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe("createDocumentB2BSalesJSONReport", () => {
    it("should return JSON data", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/finance/document-b2b-sales/json", request, undefined);
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe("getProductsBuyout", () => {
    it("should handle date range requirement", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/finance/products/buyout", request, undefined);
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe("getTransactionList", () => {
    it("should handle pagination and filters", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v3/finance/transaction/list", request, undefined);
      expect(result).toEqual(mockResponse);
    });
  ...
  describe("getTransactionTotals", () => {
    ...
    it("should handle posting number filter", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v3/finance/transaction/totals", request, undefined);
    });
  });
  ...
  describe("error handling", () => {
    it("should propagate HTTP client errors", async () => {
      ...
      await expect(financeApi.createCompensationReport({ date: "2023-01" })).rejects.toThrow("Network error");
    });
  });
