...
describe('CertificationApi', () => {
  ...
  describe('getCertificateProducts', () => {
    it('should get certificate products successfully', async () => {
      ...
      const result = await certificationApi.getCertificateProducts(request);
  ...
  describe('getCertificateAccordanceTypes', () => {
    it('should get certificate accordance types successfully', async () => {
      ...
      const result = await certificationApi.getCertificateAccordanceTypes();
