...
import type { ReviewChangeStatusRequest, CommentCreateRequest, CommentDeleteRequest, CommentListRequest, ReviewCountRequest, ReviewInfoRequest, ReviewListRequest } from "../../../../src/types/requests/review.js";
import type { ReviewChangeStatusResponse, CommentCreateResponse, CommentDeleteResponse, CommentListResponse, ReviewCountResponse, ReviewInfoResponse, ReviewListResponse } from "../../../../src/types/responses/review.js";
...
describe("ReviewApi", () => {
  ...
  describe("changeStatus", () => {
    it("should change review status successfully", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/review/change-status", request, undefined);
  ...
  describe("createComment", () => {
    it("should create comment on review successfully", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/review/comment/create", request, undefined);
      expect(result).toEqual(expectedResponse);
    });
  ...
  describe("deleteComment", () => {
    it("should delete comment successfully", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/review/comment/delete", request, undefined);
      expect(result).toEqual(expectedResponse);
    });
  });
  ...
  describe("getCommentList", () => {
    it("should get comment list with pagination", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/review/comment/list", request, undefined);
      expect(result).toEqual(expectedResponse);
  ...
  describe("getCount", () => {
    it("should get review count statistics", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/review/count", {}, undefined);
      expect(result).toEqual(expectedResponse);
    });
  ...
  describe("getInfo", () => {
    it("should get detailed review information", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/review/info", request, undefined);
      expect(result).toEqual(expectedResponse);
  ...
  describe("getList", () => {
    it("should get review list with default parameters", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/review/list", { limit: 20 }, undefined);
      expect(result).toEqual(expectedResponse);
    });
    ...
    it("should get review list with filtering and pagination", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/review/list", request, undefined);
      expect(result).toEqual(expectedResponse);
