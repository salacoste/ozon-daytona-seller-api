...
import type { GetCompetitorsRequest, CreatePricingStrategyRequest, DeletePricingStrategyRequest, GetStrategyInfoRequest, GetStrategyListRequest, AddStrategyItemsRequest, DeleteStrategyItemsRequest, UpdateStatusStrategyRequest } from "../../src/types/requests/pricing-strategy.js";
import type { GetCompetitorsResponse, CreatePricingStrategyResponse, EmptyResponse, GetStrategyResponse, GetStrategyListResponse, AddStrategyItemsResponse, DeleteStrategyItemsResponse } from "../../src/types/responses/pricing-strategy.js";
...
describe("PricingStrategyApi", () => {
  ...
  describe("getCompetitors", () => {
    it("should call correct endpoint with request data", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/pricing-strategy/competitors/list", request, undefined);
  ...
  describe("createStrategy", () => {
    it("should create pricing strategy with required name", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/pricing-strategy/create", request, undefined);
      expect(result).toEqual(mockResponse);
    });
  ...
  describe("deleteStrategy", () => {
    it("should delete strategy by ID", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/pricing-strategy/delete", request, undefined);
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe("getStrategyInfo", () => {
    it("should get strategy information", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/pricing-strategy/info", request, undefined);
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe("getStrategiesList", () => {
    it("should get strategies with pagination", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/pricing-strategy/list", request, undefined);
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe("addItemsToStrategy", () => {
    it("should add items to strategy", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/pricing-strategy/products/add", request, undefined);
      expect(result).toEqual(mockResponse);
    });
  ...
  describe("removeItemsFromStrategy", () => {
    it("should remove items from strategy", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/pricing-strategy/products/delete", request, undefined);
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe("updateStrategyStatus", () => {
    it("should update strategy status", async () => {
      ...
      expect(mockHttpClient.request).toHaveBeenCalledWith("POST", "/v1/pricing-strategy/status", request, undefined);
      expect(result).toEqual(mockResponse);
    });
  ...
  describe("error handling", () => {
    it("should propagate HTTP client errors", async () => {
      ...
      await expect(pricingApi.getCompetitors({})).rejects.toThrow("Network error");
    });
  });
