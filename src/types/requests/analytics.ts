 ...
 */
export type AnalyticsItemTag = "ITEM_ATTRIBUTE_NONE" | "ECONOM" | "NOVEL" | "DISCOUNT" | "FBS_RETURN" | "SUPER";

/**
 * Статус ликвидности товара
 * Turnover grade status
 */
export type AnalyticsTurnoverGrade = "UNSPECIFIED" | "TURNOVER_GRADE_NONE" | "DEFICIT" | "POPULAR" | "ACTUAL" | "SURPLUS" | "NO_SALES" | "WAS_NO_SALES" | "RESTRICTED_NO_SALES" | "COLLECTING_DATA" | "WAITING_FOR_SUPPLY" | "WAS_DEFICIT" | "WAS_POPULAR" | "WAS_ACTUAL" | "WAS_SURPLUS";
