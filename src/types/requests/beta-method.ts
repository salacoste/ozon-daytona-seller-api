 ...
 */
export type BetaMethodItemTag = "ITEM_ATTRIBUTE_NONE" | "ECONOM" | "NOVEL" | "DISCOUNT" | "FBS_RETURN" | "SUPER";

/**
 * Статус ликвидности товара
 * Product turnover status
 */
export type BetaMethodTurnoverGrade = "TURNOVER_GRADE_NONE" | "DEFICIT" | "POPULAR" | "ACTUAL" | "SURPLUS" | "NO_SALES" | "WAS_NO_SALES" | "RESTRICTED_NO_SALES" | "COLLECTING_DATA" | "WAITING_FOR_SUPPLY" | "WAS_DEFICIT" | "WAS_POPULAR" | "WAS_ACTUAL" | "WAS_SURPLUS";
