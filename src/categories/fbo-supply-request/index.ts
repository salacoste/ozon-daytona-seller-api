...
export class FboSupplyRequestApi {
   ...
   * ```
   */
  async createCargoLabels(request: FboSupplyRequestCargoesLabelCreateRequest, options?: RequestOptions): Promise<FboSupplyRequestCargoesLabelCreateResponse> {
    return this.httpClient.request<FboSupplyRequestCargoesLabelCreateRequest, FboSupplyRequestCargoesLabelCreateResponse>("POST", "/v1/cargoes-label/create", request, options);
  }
   ...
   * ```
   */
  async getCargoLabels(request: FboSupplyRequestCargoesLabelGetRequest, options?: RequestOptions): Promise<FboSupplyRequestCargoesLabelGetResponse> {
    return this.httpClient.request<FboSupplyRequestCargoesLabelGetRequest, FboSupplyRequestCargoesLabelGetResponse>("POST", "/v1/cargoes-label/get", request, options);
  }
   ...
   * ```
   */
  async getCargoLabelsFile(fileGuid: string, options?: RequestOptions): Promise<{ file: Blob; [key: string]: unknown }> {
    return this.httpClient.request<{}, { file: Blob; [key: string]: unknown }>("GET", `/v1/cargoes-label/file/${fileGuid}`, {}, options);
  }
   ...
   * ```
   */
  async createCargoes(request: FboSupplyRequestCargoesCreateRequest, options?: RequestOptions): Promise<FboSupplyRequestCargoesCreateResponse> {
    return this.httpClient.request<FboSupplyRequestCargoesCreateRequest, FboSupplyRequestCargoesCreateResponse>("POST", "/v1/cargoes/create", request, options);
  }
   ...
   * ```
   */
  async getCargoesCreateInfo(request: FboSupplyRequestCargoesCreateInfoRequest, options?: RequestOptions): Promise<FboSupplyRequestCargoesCreateInfoResponse> {
    return this.httpClient.request<FboSupplyRequestCargoesCreateInfoRequest, FboSupplyRequestCargoesCreateInfoResponse>("POST", "/v1/cargoes/create/info", request, options);
  }
   ...
   * ```
   */
  async deleteCargoes(request: FboSupplyRequestCargoesDeleteRequest, options?: RequestOptions): Promise<FboSupplyRequestCargoesDeleteResponse> {
    return this.httpClient.request<FboSupplyRequestCargoesDeleteRequest, FboSupplyRequestCargoesDeleteResponse>("POST", "/v1/cargoes/delete", request, options);
  }
   ...
   * ```
   */
  async getCargoesDeleteStatus(request: FboSupplyRequestCargoesDeleteStatusRequest, options?: RequestOptions): Promise<FboSupplyRequestCargoesDeleteStatusResponse> {
    return this.httpClient.request<FboSupplyRequestCargoesDeleteStatusRequest, FboSupplyRequestCargoesDeleteStatusResponse>("POST", "/v1/cargoes/delete/status", request, options);
  }
   ...
   * ```
   */
  async getCargoRules(request: FboSupplyRequestCargoesRulesGetRequest, options?: RequestOptions): Promise<FboSupplyRequestCargoesRulesGetResponse> {
    return this.httpClient.request<FboSupplyRequestCargoesRulesGetRequest, FboSupplyRequestCargoesRulesGetResponse>("POST", "/v1/cargoes/rules/get", request, options);
  }
   ...
   * ```
   */
  async getClusterList(request: FboSupplyRequestClusterListRequest, options?: RequestOptions): Promise<FboSupplyRequestClusterListResponse> {
    return this.httpClient.request<FboSupplyRequestClusterListRequest, FboSupplyRequestClusterListResponse>("POST", "/v1/cluster/list", request, options);
  }
   ...
   * ```
   */
  async getWarehouseFboList(request: FboSupplyRequestWarehouseFboListRequest, options?: RequestOptions): Promise<FboSupplyRequestWarehouseFboListResponse> {
    return this.httpClient.request<FboSupplyRequestWarehouseFboListRequest, FboSupplyRequestWarehouseFboListResponse>("POST", "/v1/warehouse/fbo/list", request, options);
  }
   ...
   * ```
   */
  async createDraft(request: FboSupplyRequestDraftCreateRequest, options?: RequestOptions): Promise<FboSupplyRequestDraftCreateResponse> {
    return this.httpClient.request<FboSupplyRequestDraftCreateRequest, FboSupplyRequestDraftCreateResponse>("POST", "/v1/draft/create", request, options);
  }
   ...
   * ```
   */
  async getDraftInfo(request: FboSupplyRequestDraftCreateInfoRequest, options?: RequestOptions): Promise<FboSupplyRequestDraftCreateInfoResponse> {
    return this.httpClient.request<FboSupplyRequestDraftCreateInfoRequest, FboSupplyRequestDraftCreateInfoResponse>("POST", "/v1/draft/create/info", request, options);
  }
   ...
   * ```
   */
  async getTimeslotInfo(request: FboSupplyRequestDraftTimeslotInfoRequest, options?: RequestOptions): Promise<FboSupplyRequestDraftTimeslotInfoResponse> {
    return this.httpClient.request<FboSupplyRequestDraftTimeslotInfoRequest, FboSupplyRequestDraftTimeslotInfoResponse>("POST", "/v1/draft/timeslot/info", request, options);
  }
   ...
   * ```
   */
  async createSupplyOrderFromDraft(request: FboSupplyRequestDraftSupplyCreateRequest, options?: RequestOptions): Promise<FboSupplyRequestDraftSupplyCreateResponse> {
    return this.httpClient.request<FboSupplyRequestDraftSupplyCreateRequest, FboSupplyRequestDraftSupplyCreateResponse>("POST", "/v1/draft/supply/create", request, options);
  }
   ...
   * ```
   */
  async getSupplyOrderCreateStatus(request: FboSupplyRequestDraftSupplyCreateStatusRequest, options?: RequestOptions): Promise<FboSupplyRequestDraftSupplyCreateStatusResponse> {
    return this.httpClient.request<FboSupplyRequestDraftSupplyCreateStatusRequest, FboSupplyRequestDraftSupplyCreateStatusResponse>("POST", "/v1/draft/supply/create/status", request, options);
  }
   ...
   * ```
   */
  async cancelSupplyOrder(request: FboSupplyRequestSupplyOrderCancelRequest, options?: RequestOptions): Promise<FboSupplyRequestSupplyOrderCancelResponse> {
    return this.httpClient.request<FboSupplyRequestSupplyOrderCancelRequest, FboSupplyRequestSupplyOrderCancelResponse>("POST", "/v1/supply-order/cancel", request, options);
  }
   ...
   * ```
   */
  async getSupplyOrderCancelStatus(request: FboSupplyRequestSupplyOrderCancelStatusRequest, options?: RequestOptions): Promise<FboSupplyRequestSupplyOrderCancelStatusResponse> {
    return this.httpClient.request<FboSupplyRequestSupplyOrderCancelStatusRequest, FboSupplyRequestSupplyOrderCancelStatusResponse>("POST", "/v1/supply-order/cancel/status", request, options);
  }
   ...
   * ```
   */
  async updateSupplyOrderContent(request: FboSupplyRequestSupplyOrderContentUpdateRequest, options?: RequestOptions): Promise<FboSupplyRequestSupplyOrderContentUpdateResponse> {
    return this.httpClient.request<FboSupplyRequestSupplyOrderContentUpdateRequest, FboSupplyRequestSupplyOrderContentUpdateResponse>("POST", "/v1/supply-order/content/update", request, options);
  }
   ...
   * ```
   */
  async getSupplyOrderContentUpdateStatus(request: FboSupplyRequestSupplyOrderContentUpdateStatusRequest, options?: RequestOptions): Promise<FboSupplyRequestSupplyOrderContentUpdateStatusResponse> {
    return this.httpClient.request<FboSupplyRequestSupplyOrderContentUpdateStatusRequest, FboSupplyRequestSupplyOrderContentUpdateStatusResponse>("POST", "/v1/supply-order/content/update/status", request, options);
  }
}
