...
export class DeliveryRfbsApi {
   ...
   */
  async setCutoff(
    request: DeliveryRfbsSetCutoffRequest,
    options?: RequestOptions
  ): Promise<DeliveryRfbsSetCutoffResponse> {
  ...
  async getTimeslotChangeRestrictions(
    request: DeliveryRfbsTimeslotChangeRestrictionsRequest,
    options?: RequestOptions
  ): Promise<DeliveryRfbsTimeslotChangeRestrictionsResponse> {
    return this.httpClient.request<
      DeliveryRfbsTimeslotChangeRestrictionsRequest,
      DeliveryRfbsTimeslotChangeRestrictionsResponse
    >(
   ...
   */
  async setTimeslot(
    request: DeliveryRfbsTimeslotSetRequest,
    options?: RequestOptions
  ): Promise<DeliveryRfbsTimeslotSetResponse> {
    return this.httpClient.request<
      DeliveryRfbsTimeslotSetRequest,
      DeliveryRfbsTimeslotSetResponse
    >(
   ...
   */
  async setDelivered(
    request: DeliveryRfbsPostingDeliveredRequest,
    options?: RequestOptions
  ): Promise<DeliveryRfbsPostingDeliveredResponse> {
    return this.httpClient.request<
      DeliveryRfbsPostingDeliveredRequest,
      DeliveryRfbsPostingDeliveredResponse
    >(
   ...
   */
  async setDelivering(
    request: DeliveryRfbsPostingDeliveringRequest,
    options?: RequestOptions
  ): Promise<DeliveryRfbsPostingDeliveringResponse> {
    return this.httpClient.request<
      DeliveryRfbsPostingDeliveringRequest,
      DeliveryRfbsPostingDeliveringResponse
    >(
   ...
   */
  async setLastMile(
    request: DeliveryRfbsPostingLastMileRequest,
    options?: RequestOptions
  ): Promise<DeliveryRfbsPostingLastMileResponse> {
    return this.httpClient.request<
      DeliveryRfbsPostingLastMileRequest,
      DeliveryRfbsPostingLastMileResponse
    >(
  ...
  async setSentBySeller(
    request: DeliveryRfbsPostingSentBySellerRequest,
    options?: RequestOptions
  ): Promise<DeliveryRfbsPostingSentBySellerResponse> {
    return this.httpClient.request<
      DeliveryRfbsPostingSentBySellerRequest,
      DeliveryRfbsPostingSentBySellerResponse
    >(
  ...
  async setTrackingNumbers(
    request: DeliveryRfbsTrackingNumberSetRequest,
    options?: RequestOptions
  ): Promise<DeliveryRfbsTrackingNumberSetResponse> {
    return this.httpClient.request<
      DeliveryRfbsTrackingNumberSetRequest,
      DeliveryRfbsTrackingNumberSetResponse
    >(
