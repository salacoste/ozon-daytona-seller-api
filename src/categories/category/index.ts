...
import type { 
  CategoryGetTreeRequest,
  CategoryGetAttributesRequest,
  CategoryGetAttributeValuesRequest,
  CategorySearchAttributeValuesRequest
} from '../../types/requests/category.js';
import type { 
  CategoryGetTreeResponse,
  CategoryGetAttributesResponse,
  CategoryGetAttributeValuesResponse,
  CategorySearchAttributeValuesResponse
} from '../../types/responses/category.js';
...
export class CategoryApi {
  ...
  async getCategoryTree(
    request: CategoryGetTreeRequest = {},
    options?: RequestOptions
  ): Promise<CategoryGetTreeResponse> {
    return this.httpClient.request<CategoryGetTreeRequest, CategoryGetTreeResponse>(
      'POST',
  ...
  async getCategoryAttributes(
    request: CategoryGetAttributesRequest,
    options?: RequestOptions
  ): Promise<CategoryGetAttributesResponse> {
    return this.httpClient.request<CategoryGetAttributesRequest, CategoryGetAttributesResponse>(
      'POST',
