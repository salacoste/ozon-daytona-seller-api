...
export class ReturnApi {
   ...
   */
  async getGiveoutBarcode(
    options?: RequestOptions
  ): Promise<GiveoutGetBarcodeResponse> {
    return this.httpClient.request<EmptyRequest, GiveoutGetBarcodeResponse>(
      'POST',
   ...
   */
  async resetGiveoutBarcode(
    options?: RequestOptions
  ): Promise<GiveoutBarcodeResetResponse> {
    return this.httpClient.request<EmptyRequest, GiveoutBarcodeResetResponse>(
      'POST',
  ...
  async getGiveoutPDF(
    options?: RequestOptions
  ): Promise<GiveoutGetPDFResponse> {
    return this.httpClient.request<EmptyRequest, GiveoutGetPDFResponse>(
      'POST',
  ...
  async getGiveoutPNG(
    options?: RequestOptions
  ): Promise<GiveoutGetPNGResponse> {
    return this.httpClient.request<EmptyRequest, GiveoutGetPNGResponse>(
      'POST',
  ...
  async getGiveoutInfo(
    request: GiveoutInfoRequest,
    options?: RequestOptions
  ): Promise<GiveoutInfoResponse> {
    return this.httpClient.request<GiveoutInfoRequest, GiveoutInfoResponse>(
      'POST',
   ...
   */
  async isGiveoutEnabled(
    options?: RequestOptions
  ): Promise<GiveoutIsEnabledResponse> {
    return this.httpClient.request<EmptyRequest, GiveoutIsEnabledResponse>(
      'POST',
   ...
   * ```
   */
  async getGiveoutList(
    request?: GiveoutListRequest,
    options?: RequestOptions
  ): Promise<GiveoutListResponse> {
    return this.httpClient.request<GiveoutListRequest, GiveoutListResponse>(
      'POST',
   ...
   * ```
   */
  async getReturnsCompanyFbsInfo(
    request?: ReturnsCompanyFbsInfoRequest,
    options?: RequestOptions
  ): Promise<ReturnsCompanyFbsInfoResponse> {
    return this.httpClient.request<ReturnsCompanyFbsInfoRequest, ReturnsCompanyFbsInfoResponse>(
      'POST',
