...
export class ReviewApi {
  ...
  ): Promise<ReviewChangeStatusResponse> {
    return this.httpClient.request<ReviewChangeStatusRequest, ReviewChangeStatusResponse>(
      'POST',
  ...
  async createComment(
    ...
    return this.httpClient.request<CommentCreateRequest, CommentCreateResponse>(
      'POST',
  ...
  async deleteComment(
    ...
    return this.httpClient.request<CommentDeleteRequest, CommentDeleteResponse>(
      'POST',
  ...
  async getCommentList(
    ...
    return this.httpClient.request<CommentListRequest, CommentListResponse>(
      'POST',
  ...
  async getCount(
    ...
    return this.httpClient.request<ReviewCountRequest, ReviewCountResponse>(
      'POST',
      '/v1/review/count',
      request ?? {},
      options
  ...
  async getInfo(
    ...
    return this.httpClient.request<ReviewInfoRequest, ReviewInfoResponse>(
      'POST',
      '/v1/review/info',
      request,
      options
  ...
  async getList(
    ...
    return this.httpClient.request<ReviewListRequest, ReviewListResponse>(
      'POST',
      '/v1/review/list',
      request ?? { limit: 20 },
      options
