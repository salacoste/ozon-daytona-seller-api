...
export class FinanceApi {
   ...
   * ```
   */
  async createCompensationReport(request: GetCompensationReportRequest, options?: RequestOptions): Promise<CreateReportResponse> {
    return this.httpClient.request<GetCompensationReportRequest, CreateReportResponse>("POST", "/v1/finance/compensation", request, options);
  }
   ...
   * @returns Статус создания отчёта
   */
  async createDecompensationReport(request: GetDecompensationReportRequest, options?: RequestOptions): Promise<CreateReportResponse> {
    return this.httpClient.request<GetDecompensationReportRequest, CreateReportResponse>("POST", "/v1/finance/decompensation", request, options);
  }
   ...
   */
  async createDocumentB2BSalesReport(request: CreateDocumentB2BSalesReportRequest, options?: RequestOptions): Promise<CommonCreateReportResponse> {
    return this.httpClient.request<CreateDocumentB2BSalesReportRequest, CommonCreateReportResponse>("POST", "/v1/finance/document-b2b-sales", request, options);
  }
   ...
   */
  async createDocumentB2BSalesJSONReport(request: CreateDocumentB2BSalesJSONReportRequest, options?: RequestOptions): Promise<CreateDocumentB2BSalesJSONReportResponse> {
    return this.httpClient.request<CreateDocumentB2BSalesJSONReportRequest, CreateDocumentB2BSalesJSONReportResponse>("POST", "/v1/finance/document-b2b-sales/json", request, options);
  }
   ...
   * @returns Результат создания отчёта с URL для скачивания
   */
  async createMutualSettlementReport(request: CreateMutualSettlementReportRequest, options?: RequestOptions): Promise<CommonCreateReportResponse> {
    return this.httpClient.request<CreateMutualSettlementReportRequest, CommonCreateReportResponse>("POST", "/v1/finance/mutual-settlement", request, options);
  }
   ...
   */
  async getProductsBuyout(request: GetFinanceProductsBuyoutRequest, options?: RequestOptions): Promise<GetFinanceProductsBuyoutResponse> {
    return this.httpClient.request<GetFinanceProductsBuyoutRequest, GetFinanceProductsBuyoutResponse>("POST", "/v1/finance/products/buyout", request, options);
  }
   ...
   */
  async getRealizationReportPosting(request: GetRealizationReportPostingRequest, options?: RequestOptions): Promise<GetRealizationReportPostingResponse> {
    return this.httpClient.request<GetRealizationReportPostingRequest, GetRealizationReportPostingResponse>("POST", "/v1/finance/realization/posting", request, options);
  }
   ...
   */
  async getRealizationReportV2(request: GetRealizationReportV2Request, options?: RequestOptions): Promise<GetRealizationReportV2Response> {
    return this.httpClient.request<GetRealizationReportV2Request, GetRealizationReportV2Response>("POST", "/v2/finance/realization", request, options);
  }
   ...
   */
  async getTransactionList(request: FinanceTransactionListV3Request, options?: RequestOptions): Promise<FinanceTransactionListV3Response> {
    return this.httpClient.request<FinanceTransactionListV3Request, FinanceTransactionListV3Response>("POST", "/v3/finance/transaction/list", request, options);
  }
   ...
   */
  async getTransactionTotals(request: FinanceTransactionTotalsV3Request, options?: RequestOptions): Promise<FinanceTransactionTotalsV3Response> {
    return this.httpClient.request<FinanceTransactionTotalsV3Request, FinanceTransactionTotalsV3Response>("POST", "/v3/finance/transaction/totals", request, options);
  }
}
