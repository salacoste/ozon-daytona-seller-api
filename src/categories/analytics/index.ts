...
export class AnalyticsApi {
  ...
  async getAnalyticsStocks(
    request: AnalyticsStocksV1Request,
    options?: RequestOptions
  ): Promise<AnalyticsStocksV1Response> {
    ...
    return this.httpClient.request<AnalyticsStocksV1Request, AnalyticsStocksV1Response>(
      'POST',
      '/v1/analytics/stocks',
      request,
      options
