...
import type { QuestionAnswerCreateRequest, QuestionAnswerDeleteRequest, QuestionAnswerListRequest, QuestionChangeStatusRequest, QuestionCountRequest, QuestionInfoRequest, QuestionListRequest, QuestionTopSkuRequest } from "../../types/requests/questions-answers.js";
import type { QuestionAnswerCreateResponse, QuestionAnswerDeleteResponse, QuestionAnswerListResponse, QuestionChangeStatusResponse, QuestionCountResponse, QuestionInfoResponse, QuestionListResponse, QuestionTopSkuResponse } from "../../types/responses/questions-answers.js";
...
export class QuestionsAnswersApi {
   ...
   * ```
   */
  async createAnswer(request: QuestionAnswerCreateRequest, options?: RequestOptions): Promise<QuestionAnswerCreateResponse> {
    return this.httpClient.request<QuestionAnswerCreateRequest, QuestionAnswerCreateResponse>("POST", "/v1/question/answer/create", request, options);
  }
   ...
   * ```
   */
  async deleteAnswer(request: QuestionAnswerDeleteRequest, options?: RequestOptions): Promise<QuestionAnswerDeleteResponse> {
    return this.httpClient.request<QuestionAnswerDeleteRequest, QuestionAnswerDeleteResponse>("POST", "/v1/question/answer/delete", request, options);
  }
   ...
   * ```
   */
  async getAnswerList(request: QuestionAnswerListRequest, options?: RequestOptions): Promise<QuestionAnswerListResponse> {
    return this.httpClient.request<QuestionAnswerListRequest, QuestionAnswerListResponse>("POST", "/v1/question/answer/list", request, options);
  }
   ...
   * ```
   */
  async changeQuestionStatus(request: QuestionChangeStatusRequest, options?: RequestOptions): Promise<QuestionChangeStatusResponse> {
    return this.httpClient.request<QuestionChangeStatusRequest, QuestionChangeStatusResponse>("POST", "/v1/question/change-status", request, options);
  }
   ...
   * ```
   */
  async getQuestionCount(request?: QuestionCountRequest, options?: RequestOptions): Promise<QuestionCountResponse> {
    return this.httpClient.request<QuestionCountRequest, QuestionCountResponse>("POST", "/v1/question/count", request ?? {}, options);
  }
   ...
   * ```
   */
  async getQuestionInfo(request: QuestionInfoRequest, options?: RequestOptions): Promise<QuestionInfoResponse> {
    return this.httpClient.request<QuestionInfoRequest, QuestionInfoResponse>("POST", "/v1/question/info", request, options);
  }
   ...
   * ```
   */
  async getQuestionList(request?: QuestionListRequest, options?: RequestOptions): Promise<QuestionListResponse> {
    return this.httpClient.request<QuestionListRequest, QuestionListResponse>("POST", "/v1/question/list", request ?? {}, options);
  }
   ...
   * ```
   */
  async getTopQuestionedProducts(request: QuestionTopSkuRequest, options?: RequestOptions): Promise<QuestionTopSkuResponse> {
    return this.httpClient.request<QuestionTopSkuRequest, QuestionTopSkuResponse>("POST", "/v1/question/top-sku", request, options);
  }
}
