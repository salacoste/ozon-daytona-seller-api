...
import type { 
  SellerRatingHistoryRequest
} from '../../types/requests/seller-rating.js';
import type { 
...
export class SellerRatingApi {
  ...
  async getRatingHistory(
    request: SellerRatingHistoryRequest,
    options?: RequestOptions
  ): Promise<SellerRatingHistoryResponse> {
    return this.httpClient.request<SellerRatingHistoryRequest, SellerRatingHistoryResponse>(
      'POST',
      '/v1/rating/history',
      request,
      options
