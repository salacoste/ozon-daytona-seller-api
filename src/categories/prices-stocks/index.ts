...
export class PricesStocksApi {
   ...
   * ```
   */
  async getActionTimerStatus(request: PricesStocksActionTimerStatusRequest, options?: RequestOptions): Promise<PricesStocksActionTimerStatusResponse> {
    return this.httpClient.request<PricesStocksActionTimerStatusRequest, PricesStocksActionTimerStatusResponse>("POST", "/v1/product/action/timer/status", request, options);
  }
   ...
   * ```
   */
  async updateActionTimer(request: PricesStocksActionTimerUpdateRequest, options?: RequestOptions): Promise<void> {
    await this.httpClient.request<PricesStocksActionTimerUpdateRequest, EmptyResponse>("POST", "/v1/product/action/timer/update", request, options);
  }
   ...
   * ```
   */
  async updatePrices(request: PricesStocksImportPricesRequest, options?: RequestOptions): Promise<PricesStocksImportPricesResponse> {
    return this.httpClient.request<PricesStocksImportPricesRequest, PricesStocksImportPricesResponse>("POST", "/v1/product/import/prices", request, options);
  }
   ...
   * ```
   */
  async getDiscountedProductInfo(request: PricesStocksGetDiscountedInfoRequest, options?: RequestOptions): Promise<PricesStocksGetDiscountedInfoResponse> {
    return this.httpClient.request<PricesStocksGetDiscountedInfoRequest, PricesStocksGetDiscountedInfoResponse>("POST", "/v1/product/info/discounted", request, options);
  }
   ...
   * ```
   */
  async getStocksByWarehouseFbs(request: PricesStocksGetStocksByWarehouseFbsRequest, options?: RequestOptions): Promise<PricesStocksGetStocksByWarehouseFbsResponse> {
    return this.httpClient.request<PricesStocksGetStocksByWarehouseFbsRequest, PricesStocksGetStocksByWarehouseFbsResponse>("POST", "/v1/product/info/stocks-by-warehouse/fbs", request, options);
  }
   ...
   * ```
   */
  async updateDiscountedProductDiscount(request: PricesStocksUpdateDiscountRequest, options?: RequestOptions): Promise<PricesStocksUpdateDiscountResponse> {
    return this.httpClient.request<PricesStocksUpdateDiscountRequest, PricesStocksUpdateDiscountResponse>("POST", "/v1/product/update/discount", request, options);
  }
   ...
   * ```
   */
  async updateStocks(request: PricesStocksUpdateStocksRequest, options?: RequestOptions): Promise<PricesStocksUpdateStocksResponse> {
    return this.httpClient.request<PricesStocksUpdateStocksRequest, PricesStocksUpdateStocksResponse>("POST", "/v2/products/stocks", request, options);
  }
   ...
   * ```
   */
  async getStocks(request: PricesStocksGetStocksRequest, options?: RequestOptions): Promise<PricesStocksGetStocksResponse> {
    return this.httpClient.request<PricesStocksGetStocksRequest, PricesStocksGetStocksResponse>("POST", "/v4/product/info/stocks", request, options);
  }
   ...
   * ```
   */
  async getPrices(request: PricesStocksGetPricesRequest, options?: RequestOptions): Promise<PricesStocksGetPricesResponse> {
    return this.httpClient.request<PricesStocksGetPricesRequest, PricesStocksGetPricesResponse>("POST", "/v5/product/info/prices", request, options);
  }
}
