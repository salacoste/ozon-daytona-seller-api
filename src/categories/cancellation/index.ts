...
import type { 
  CancellationGetListRequest,
  CancellationGetRequest,
  CancellationMoveRequest,
  CancellationGetListV2Request,
  CancellationApproveV2Request,
  CancellationRejectV2Request
} from '../../types/requests/cancellation.js';
import type { 
  CancellationGetListResponse,
  CancellationGetResponse,
  CancellationGetListV2Response
} from '../../types/responses/cancellation.js';
...
export class CancellationApi {
   ...
   * ```
   */
  async getConditionalCancellationList(
    request: CancellationGetListRequest,
    options?: RequestOptions
  ): Promise<CancellationGetListResponse> {
    return this.httpClient.request<CancellationGetListRequest, CancellationGetListResponse>(
      'POST',
   ...
   * ```
   */
  async getConditionalCancellation(
    request: CancellationGetRequest,
    options?: RequestOptions
  ): Promise<CancellationGetResponse> {
    return this.httpClient.request<CancellationGetRequest, CancellationGetResponse>(
      'POST',
   ...
   * ```
   */
  async approveConditionalCancellation(
    request: CancellationMoveRequest,
    options?: RequestOptions
  ): Promise<void> {
    await this.httpClient.request<CancellationMoveRequest, EmptyResponse>(
      'POST',
   ...
   * ```
   */
  async rejectConditionalCancellation(
    request: CancellationMoveRequest,
    options?: RequestOptions
  ): Promise<void> {
    await this.httpClient.request<CancellationMoveRequest, EmptyResponse>(
   ...
   * ```
   */
  async getConditionalCancellationListV2(
    request: CancellationGetListV2Request,
    options?: RequestOptions
  ): Promise<CancellationGetListV2Response> {
    return this.httpClient.request<CancellationGetListV2Request, CancellationGetListV2Response>(
      'POST',
  ...
  async approveConditionalCancellationV2(
    request: CancellationApproveV2Request,
    options?: RequestOptions
  ): Promise<void> {
    await this.httpClient.request<CancellationApproveV2Request, EmptyResponse>(
      'POST',
  ...
  async rejectConditionalCancellationV2(
    request: CancellationRejectV2Request,
    options?: RequestOptions
  ): Promise<void> {
    await this.httpClient.request<CancellationRejectV2Request, EmptyResponse>(
      'POST',
