...
export class CertificationApi {
   ...
   * ```
   */
  async getCertificateList(request: CertificateListRequest, options?: RequestOptions): Promise<CertificateListResponse> {
    return this.httpClient.request<CertificateListRequest, CertificateListResponse>("POST", "/v1/product/certificate/list", request, options);
  }
   ...
   * ```
   */
  async bindCertificate(request: CertificateBindRequest, options?: RequestOptions): Promise<CertificateBindResponse> {
    return this.httpClient.request<CertificateBindRequest, CertificateBindResponse>("POST", "/v1/product/certificate/bind", request, options);
  }
   ...
   * ```
   */
  async createCertificate(request: CertificateCreateRequest, options?: RequestOptions): Promise<CertificateCreateResponse> {
    return this.httpClient.request<CertificateCreateRequest, CertificateCreateResponse>("POST", "/v1/product/certificate/create", request, options);
  }
   ...
   * ```
   */
  async deleteCertificates(request: CertificateDeleteRequest, options?: RequestOptions): Promise<CertificateDeleteResponse> {
    return this.httpClient.request<CertificateDeleteRequest, CertificateDeleteResponse>("POST", "/v1/product/certificate/delete", request, options);
  }
   ...
   * ```
   */
  async getCertificateInfo(request: CertificateInfoRequest, options?: RequestOptions): Promise<CertificateInfoResponse> {
    return this.httpClient.request<CertificateInfoRequest, CertificateInfoResponse>("POST", "/v1/product/certificate/info", request, options);
  }
   ...
   * ```
   */
  async getCertificateProductsList(request: CertificateProductsListRequest, options?: RequestOptions): Promise<CertificateProductsListResponse> {
    return this.httpClient.request<CertificateProductsListRequest, CertificateProductsListResponse>("POST", "/v1/product/certificate/products/list", request, options);
  }
   ...
   * ```
   */
  async getProductStatusList(request?: ProductStatusListRequest, options?: RequestOptions): Promise<ProductStatusListResponse> {
    return this.httpClient.request<ProductStatusListRequest, ProductStatusListResponse>("POST", "/v1/product/certificate/product_status/list", request ?? {}, options);
  }
   ...
   * ```
   */
  async getRejectionReasons(request?: CertificateRejectionReasonsListRequest, options?: RequestOptions): Promise<CertificateRejectionReasonsListResponse> {
    return this.httpClient.request<CertificateRejectionReasonsListRequest, CertificateRejectionReasonsListResponse>("POST", "/v1/product/certificate/rejection_reasons/list", request ?? {}, options);
  }
   ...
   * ```
   */
  async getCertificateStatuses(request?: CertificateStatusListRequest, options?: RequestOptions): Promise<CertificateStatusListResponse> {
    return this.httpClient.request<CertificateStatusListRequest, CertificateStatusListResponse>("POST", "/v1/product/certificate/status/list", request ?? {}, options);
  }
   ...
   * ```
   */
  async getCertificateTypes(options?: RequestOptions): Promise<ProductCertificateTypesResponse> {
    return this.httpClient.request<Record<string, never>, ProductCertificateTypesResponse>("GET", "/v1/product/certificate/types", {} as Record<string, never>, options);
  }
   ...
   * ```
   */
  async unbindCertificate(request: CertificateUnbindRequest, options?: RequestOptions): Promise<CertificateUnbindResponse> {
    return this.httpClient.request<CertificateUnbindRequest, CertificateUnbindResponse>("POST", "/v1/product/certificate/unbind", request, options);
  }
   ...
   */
  async getProductCertificationList(request: ProductCertificationListRequest, options?: RequestOptions): Promise<ProductCertificationListResponse> {
    return this.httpClient.request<ProductCertificationListRequest, ProductCertificationListResponse>("POST", "/v1/product/certification/list", request, options);
  }
   ...
   * ```
   */
  async getCertificateAccordanceTypesV1(options?: RequestOptions): Promise<CertificateAccordanceTypesV1Response> {
    return this.httpClient.request<Record<string, never>, CertificateAccordanceTypesV1Response>("GET", "/v1/product/certificate/accordance-types", {} as Record<string, never>, options);
  }
   ...
   * ```
   */
  async getCertificateAccordanceTypesV2(options?: RequestOptions): Promise<CertificateAccordanceTypesResponse> {
    return this.httpClient.request<Record<string, never>, CertificateAccordanceTypesResponse>("GET", "/v2/product/certificate/accordance-types/list", {} as Record<string, never>, options);
  }
   ...
   * ```
   */
  async getProductCertificationListV2(request: ProductCertificationListV2Request, options?: RequestOptions): Promise<ProductCertificationListV2Response> {
    ...
    return this.httpClient.request<ProductCertificationListV2Request, ProductCertificationListV2Response>("POST", "/v2/product/certification/list", request, options);
  }
}
