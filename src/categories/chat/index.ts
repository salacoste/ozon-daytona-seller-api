...
import type { ChatStartRequest, ChatSendMessageRequest, ChatSendFileRequest, ChatReadRequest, ChatHistoryV2Request, ChatHistoryV3Request, ChatListV2Request, ChatListV3Request } from "../../types/requests/chat.js";
import type { ChatStartResponse, ChatSendMessageResponse, ChatSendFileResponse, ChatReadResponse, ChatHistoryV2Response, ChatHistoryV3Response, ChatListV2Response, ChatListV3Response } from "../../types/responses/chat.js";
...
export class ChatApi {
   ...
   * ```
   */
  async startChat(request: ChatStartRequest, options?: RequestOptions): Promise<ChatStartResponse> {
    return this.httpClient.request<ChatStartRequest, ChatStartResponse>("POST", "/v1/chat/start", request, options);
  }
   ...
   * ```
   */
  async sendMessage(request: ChatSendMessageRequest, options?: RequestOptions): Promise<ChatSendMessageResponse> {
    return this.httpClient.request<ChatSendMessageRequest, ChatSendMessageResponse>("POST", "/v1/chat/send/message", request, options);
  }
   ...
   * ```
   */
  async sendFile(request: ChatSendFileRequest, options?: RequestOptions): Promise<ChatSendFileResponse> {
    return this.httpClient.request<ChatSendFileRequest, ChatSendFileResponse>("POST", "/v1/chat/send/file", request, options);
  }
   ...
   * ```
   */
  async markAsRead(request: ChatReadRequest, options?: RequestOptions): Promise<ChatReadResponse> {
    return this.httpClient.request<ChatReadRequest, ChatReadResponse>("POST", "/v2/chat/read", request, options);
  }
   ...
   * ```
   */
  async getChatHistoryV2(request: ChatHistoryV2Request, options?: RequestOptions): Promise<ChatHistoryV2Response> {
    return this.httpClient.request<ChatHistoryV2Request, ChatHistoryV2Response>("POST", "/v2/chat/history", request, options);
  }
   ...
   * ```
   */
  async getChatHistoryV3(request: ChatHistoryV3Request, options?: RequestOptions): Promise<ChatHistoryV3Response> {
    return this.httpClient.request<ChatHistoryV3Request, ChatHistoryV3Response>("POST", "/v3/chat/history", request, options);
  }
   ...
   * ```
   */
  async getChatListV2(request?: ChatListV2Request, options?: RequestOptions): Promise<ChatListV2Response> {
    return this.httpClient.request<ChatListV2Request, ChatListV2Response>("POST", "/v2/chat/list", request ?? { limit: 30 }, options);
  }
   ...
   * ```
   */
  async getChatListV3(request?: ChatListV3Request, options?: RequestOptions): Promise<ChatListV3Response> {
    return this.httpClient.request<ChatListV3Request, ChatListV3Response>("POST", "/v3/chat/list", request ?? { limit: 30 }, options);
  }
}
