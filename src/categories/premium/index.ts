...
import type { 
  PremiumAnalyticsGetDataRequest,
  PremiumProductQueriesRequest,
  PremiumProductQueriesDetailsRequest,
  PremiumChatSendMessageRequest,
  PremiumChatStartRequest,
  PremiumRealizationByDayRequest,
  PremiumChatReadRequest,
  PremiumChatHistoryRequest
} from '../../types/requests/premium.js';
import type { 
...
export class PremiumApi {
  ...
  async getAnalyticsData(
    ...
    return this.httpClient.request<PremiumAnalyticsGetDataRequest, PremiumAnalyticsGetDataResponse>(
      'POST',
      '/v1/analytics/data',
      request,
      options
  ...
  async getProductQueries(
    ...
    return this.httpClient.request<PremiumProductQueriesRequest, PremiumProductQueriesResponse>(
      'POST',
  ...
  async getProductQueriesDetails(
    ...
    return this.httpClient.request<PremiumProductQueriesDetailsRequest, PremiumProductQueriesDetailsResponse>(
      'POST',
  ...
  async sendChatMessage(
    ...
    return this.httpClient.request<PremiumChatSendMessageRequest, PremiumChatSendMessageResponse>(
      'POST',
  ...
  async startChat(
    ...
    return this.httpClient.request<PremiumChatStartRequest, PremiumChatStartResponse>(
      'POST',
      '/v1/chat/start',
      request,
      options
  ...
  async getRealizationByDay(
    ...
    return this.httpClient.request<PremiumRealizationByDayRequest, PremiumRealizationByDayResponse>(
      'POST',
  ...
  async markChatAsRead(
    ...
    return this.httpClient.request<PremiumChatReadRequest, PremiumChatReadResponse>(
      'POST',
      '/v2/chat/read',
      request,
      options
  ...
  async getChatHistory(
    ...
    return this.httpClient.request<PremiumChatHistoryRequest, PremiumChatHistoryResponse>(
      'POST',
      '/v3/chat/history',
      request,
      options
