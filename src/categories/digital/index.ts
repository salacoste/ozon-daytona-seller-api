...
import type { 
  DigitalUploadPostingCodesRequest,
  DigitalListPostingCodesRequest,
  DigitalStocksImportRequest
} from '../../types/requests/digital.js';
import type { 
  DigitalUploadPostingCodesResponse,
  DigitalListPostingCodesResponse,
  DigitalStocksImportResponse
} from '../../types/responses/digital.js';
...
export class DigitalApi {
   ...
   * ```
   */
  async getDigitalPostingsList(
    request: DigitalListPostingCodesRequest = {},
    options?: RequestOptions
  ): Promise<DigitalListPostingCodesResponse> {
    return this.httpClient.request<DigitalListPostingCodesRequest, DigitalListPostingCodesResponse>(
      'POST',
   ...
   * ```
   */
  async uploadDigitalCodes(
    request: DigitalUploadPostingCodesRequest,
    options?: RequestOptions
  ): Promise<DigitalUploadPostingCodesResponse> {
    return this.httpClient.request<DigitalUploadPostingCodesRequest, DigitalUploadPostingCodesResponse>(
      'POST',
   ...
   * ```
   */
  async updateDigitalStocks(
    request: DigitalStocksImportRequest,
    options?: RequestOptions
  ): Promise<DigitalStocksImportResponse> {
    return this.httpClient.request<DigitalStocksImportRequest, DigitalStocksImportResponse>(
      'POST',
