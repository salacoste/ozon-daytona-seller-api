...
export class FbsApi {
   ...
   * ```
   */
  async getCancelReasons(request: FbsCancelReasonRequest, options?: RequestOptions): Promise<FbsCancelReasonResponse> {
    return this.httpClient.request<FbsCancelReasonRequest, FbsCancelReasonResponse>("POST", "/v1/posting/fbs/cancel-reason", request, options);
  }
   ...
   * ```
   */
  async getCancelReasonsList(options?: RequestOptions): Promise<FbsCancelReasonListResponse> {
    return this.httpClient.request<{}, FbsCancelReasonListResponse>("POST", "/v2/posting/fbs/cancel-reason/list", {}, options);
  }
   ...
   */
  async createLabelBatch(request: FbsCreateLabelBatchRequest, options?: RequestOptions): Promise<FbsCreateLabelBatchResponse> {
    return this.httpClient.request<FbsCreateLabelBatchRequest, FbsCreateLabelBatchResponse>("POST", "/v1/posting/fbs/package-label/create", request, options);
  }
   ...
   * ```
   */
  async createLabelBatchV2(request: FbsCreateLabelBatchRequest, options?: RequestOptions): Promise<FbsCreateLabelBatchResponse> {
    return this.httpClient.request<FbsCreateLabelBatchRequest, FbsCreateLabelBatchResponse>("POST", "/v2/posting/fbs/package-label/create", request, options);
  }
   ...
   * ```
   */
  async getLabelBatch(request: FbsGetLabelBatchRequest, options?: RequestOptions): Promise<FbsGetLabelBatchResponse> {
    return this.httpClient.request<FbsGetLabelBatchRequest, FbsGetLabelBatchResponse>("POST", "/v1/posting/fbs/package-label/get", request, options);
  }
   ...
   * ```
   */
  async packageLabel(request: FbsPackageLabelRequest, options?: RequestOptions): Promise<FbsPackageLabelResponse> {
    return this.httpClient.request<FbsPackageLabelRequest, FbsPackageLabelResponse>("POST", "/v2/posting/fbs/package-label", request, options);
  }
   ...
   * ```
   */
  async verifyPickupCode(request: FbsPickupCodeVerifyRequest, options?: RequestOptions): Promise<FbsPickupCodeVerifyResponse> {
    return this.httpClient.request<FbsPickupCodeVerifyRequest, FbsPickupCodeVerifyResponse>("POST", "/v1/posting/fbs/pick-up-code/verify", request, options);
  }
   ...
   * ```
   */
  async getRestrictions(request: FbsGetRestrictionsRequest, options?: RequestOptions): Promise<FbsGetRestrictionsResponse> {
    return this.httpClient.request<FbsGetRestrictionsRequest, FbsGetRestrictionsResponse>("POST", "/v1/posting/fbs/restrictions", request, options);
  }
   ...
   * ```
   */
  async moveToArbitration(request: FbsMovePostingRequest, options?: RequestOptions): Promise<FbsBooleanResponse> {
    return this.httpClient.request<FbsMovePostingRequest, FbsBooleanResponse>("POST", "/v2/posting/fbs/arbitration", request, options);
  }
   ...
   * ```
   */
  async moveToAwaitingDelivery(request: FbsMovePostingRequest, options?: RequestOptions): Promise<FbsBooleanResponse> {
    return this.httpClient.request<FbsMovePostingRequest, FbsBooleanResponse>("POST", "/v2/posting/fbs/awaiting-delivery", request, options);
  }
   ...
   * ```
   */
  async cancelPosting(request: FbsCancelPostingRequest, options?: RequestOptions): Promise<FbsBooleanResponse> {
    return this.httpClient.request<FbsCancelPostingRequest, FbsBooleanResponse>("POST", "/v2/posting/fbs/cancel", request, options);
  }
   ...
   * ```
   */
  async getPostingByBarcode(request: FbsGetPostingByBarcodeRequest, options?: RequestOptions): Promise<FbsPostingResponse> {
    return this.httpClient.request<FbsGetPostingByBarcodeRequest, FbsPostingResponse>("POST", "/v2/posting/fbs/get-by-barcode", request, options);
  }
   ...
   * ```
   */
  async cancelProducts(request: FbsProductCancelRequest, options?: RequestOptions): Promise<FbsProductCancelResponse> {
    return this.httpClient.request<FbsProductCancelRequest, FbsProductCancelResponse>("POST", "/v2/posting/fbs/product/cancel", request, options);
  }
   ...
   * ```
   */
  async changeProducts(request: FbsProductChangeRequest, options?: RequestOptions): Promise<FbsProductChangeResponse> {
    return this.httpClient.request<FbsProductChangeRequest, FbsProductChangeResponse>("POST", "/v2/posting/fbs/product/change", request, options);
  }
   ...
   * ```
   */
  async getProductCountriesList(request: FbsProductCountryListRequest, options?: RequestOptions): Promise<FbsProductCountryListResponse> {
    return this.httpClient.request<FbsProductCountryListRequest, FbsProductCountryListResponse>("POST", "/v2/posting/fbs/product/country/list", request, options);
  }
   ...
   * ```
   */
  async setProductCountry(request: FbsProductCountrySetRequest, options?: RequestOptions): Promise<FbsProductCountrySetResponse> {
    return this.httpClient.request<FbsProductCountrySetRequest, FbsProductCountrySetResponse>("POST", "/v2/posting/fbs/product/country/set", request, options);
  }
   ...
   * ```
   */
  async getPostingV3(request: FbsGetPostingV3Request, options?: RequestOptions): Promise<FbsGetPostingV3Response> {
    return this.httpClient.request<FbsGetPostingV3Request, FbsGetPostingV3Response>("POST", "/v3/posting/fbs/get", request, options);
  }
   ...
   * ```
   */
  async getPostingListV3(request: FbsGetPostingListV3Request, options?: RequestOptions): Promise<FbsGetPostingListV3Response> {
    return this.httpClient.request<FbsGetPostingListV3Request, FbsGetPostingListV3Response>("POST", "/v3/posting/fbs/list", request, options);
  }
   ...
   * ```
   */
  async getUnfulfilledListV3(request: FbsGetUnfulfilledListV3Request, options?: RequestOptions): Promise<FbsGetUnfulfilledListV3Response> {
    return this.httpClient.request<FbsGetUnfulfilledListV3Request, FbsGetUnfulfilledListV3Response>("POST", "/v3/posting/fbs/unfulfilled/list", request, options);
  }
   ...
   * ```
   */
  async setMultiBoxQtyV3(request: FbsMultiBoxQtySetV3Request, options?: RequestOptions): Promise<FbsMultiBoxQtySetV3Response> {
    return this.httpClient.request<FbsMultiBoxQtySetV3Request, FbsMultiBoxQtySetV3Response>("POST", "/v3/posting/multiboxqty/set", request, options);
  }
   ...
   * ```
   */
  async getEtgb(request: FbsGetEtgbRequest, options?: RequestOptions): Promise<FbsGetEtgbResponse> {
    return this.httpClient.request<FbsGetEtgbRequest, FbsGetEtgbResponse>("POST", "/v1/posting/global/etgb", request, options);
  }
   ...
   * ```
   */
  async getUnpaidLegalProductList(request: FbsUnpaidLegalProductListRequest, options?: RequestOptions): Promise<FbsUnpaidLegalProductListResponse> {
    return this.httpClient.request<FbsUnpaidLegalProductListRequest, FbsUnpaidLegalProductListResponse>("POST", "/v1/posting/unpaid-legal/product/list", request, options);
  }
}
