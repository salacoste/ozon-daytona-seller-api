...
// Request types
import { SupplierInvoiceDeleteRequest, SupplierInvoiceFileUploadRequest, SupplierInvoiceCreateOrUpdateRequest, SupplierInvoiceGetRequest } from "../../types/requests/supplier";

// Response types
import { SupplierInvoiceDeleteResponse, SupplierInvoiceFileUploadResponse, SupplierInvoiceCreateOrUpdateResponse, SupplierInvoiceGetResponse } from "../../types/responses/supplier";
...
export class SupplierApi {
   ...
   * ```
   */
  async deleteInvoice(request: SupplierInvoiceDeleteRequest, options?: RequestOptions): Promise<SupplierInvoiceDeleteResponse> {
    return this.httpClient.request<SupplierInvoiceDeleteRequest, SupplierInvoiceDeleteResponse>("POST", "/v1/invoice/delete", request, options);
  }
   ...
   * ```
   */
  async uploadInvoiceFile(request: SupplierInvoiceFileUploadRequest, options?: RequestOptions): Promise<SupplierInvoiceFileUploadResponse> {
    return this.httpClient.request<SupplierInvoiceFileUploadRequest, SupplierInvoiceFileUploadResponse>("POST", "/v1/invoice/file/upload", request, options);
  }
   ...
   * ```
   */
  async createOrUpdateInvoice(request: SupplierInvoiceCreateOrUpdateRequest, options?: RequestOptions): Promise<SupplierInvoiceCreateOrUpdateResponse> {
    return this.httpClient.request<SupplierInvoiceCreateOrUpdateRequest, SupplierInvoiceCreateOrUpdateResponse>("POST", "/v2/invoice/create-or-update", request, options);
  }
   ...
   * ```
   */
  async getInvoice(request: SupplierInvoiceGetRequest, options?: RequestOptions): Promise<SupplierInvoiceGetResponse> {
    return this.httpClient.request<SupplierInvoiceGetRequest, SupplierInvoiceGetResponse>("POST", "/v2/invoice/get", request, options);
  }
}
