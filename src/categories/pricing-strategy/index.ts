...
export class PricingStrategyApi {
   ...
   * ```
   */
  async getCompetitors(request: GetCompetitorsRequest, options?: RequestOptions): Promise<GetCompetitorsResponse> {
    return this.httpClient.request<GetCompetitorsRequest, GetCompetitorsResponse>("POST", "/v1/pricing-strategy/competitors/list", request, options);
  }
   ...
   * ```
   */
  async createStrategy(request: CreatePricingStrategyRequest, options?: RequestOptions): Promise<CreatePricingStrategyResponse> {
    return this.httpClient.request<CreatePricingStrategyRequest, CreatePricingStrategyResponse>("POST", "/v1/pricing-strategy/create", request, options);
  }
   ...
   */
  async deleteStrategy(request: DeletePricingStrategyRequest, options?: RequestOptions): Promise<EmptyResponse> {
    return this.httpClient.request<DeletePricingStrategyRequest, EmptyResponse>("POST", "/v1/pricing-strategy/delete", request, options);
  }
   ...
   */
  async getStrategyInfo(request: GetStrategyInfoRequest, options?: RequestOptions): Promise<GetStrategyResponse> {
    return this.httpClient.request<GetStrategyInfoRequest, GetStrategyResponse>("POST", "/v1/pricing-strategy/info", request, options);
  }
   ...
   * ```
   */
  async getStrategiesList(request: GetStrategyListRequest, options?: RequestOptions): Promise<GetStrategyListResponse> {
    return this.httpClient.request<GetStrategyListRequest, GetStrategyListResponse>("POST", "/v1/pricing-strategy/list", request, options);
  }
   ...
   */
  async getStrategyItemInfo(request: GetStrategyItemInfoRequest, options?: RequestOptions): Promise<GetStrategyItemInfoResponse> {
    return this.httpClient.request<GetStrategyItemInfoRequest, GetStrategyItemInfoResponse>("POST", "/v1/pricing-strategy/product/info", request, options);
  }
   ...
   * ```
   */
  async addItemsToStrategy(request: AddStrategyItemsRequest, options?: RequestOptions): Promise<AddStrategyItemsResponse> {
    return this.httpClient.request<AddStrategyItemsRequest, AddStrategyItemsResponse>("POST", "/v1/pricing-strategy/products/add", request, options);
  }
   ...
   */
  async removeItemsFromStrategy(request: DeleteStrategyItemsRequest, options?: RequestOptions): Promise<DeleteStrategyItemsResponse> {
    return this.httpClient.request<DeleteStrategyItemsRequest, DeleteStrategyItemsResponse>("POST", "/v1/pricing-strategy/products/delete", request, options);
  }
   ...
   */
  async getStrategyItems(request: GetStrategyItemsRequest, options?: RequestOptions): Promise<GetStrategyItemsResponse> {
    return this.httpClient.request<GetStrategyItemsRequest, GetStrategyItemsResponse>("POST", "/v1/pricing-strategy/products/list", request, options);
  }
   ...
   */
  async updateStrategyStatus(request: UpdateStatusStrategyRequest, options?: RequestOptions): Promise<EmptyResponse> {
    return this.httpClient.request<UpdateStatusStrategyRequest, EmptyResponse>("POST", "/v1/pricing-strategy/status", request, options);
  }
   ...
   */
  async getStrategyIDsByItemIDs(request: GetStrategyIDsByItemIDsRequest, options?: RequestOptions): Promise<GetStrategyIDsByItemIDsResponse> {
    return this.httpClient.request<GetStrategyIDsByItemIDsRequest, GetStrategyIDsByItemIDsResponse>("POST", "/v1/pricing-strategy/strategy-ids-by-product-ids", request, options);
  }
   ...
   */
  async updateStrategy(request: UpdatePricingStrategyRequest, options?: RequestOptions): Promise<EmptyResponse> {
    return this.httpClient.request<UpdatePricingStrategyRequest, EmptyResponse>("POST", "/v1/pricing-strategy/update", request, options);
  }
}
