...
export class DeliveryFbsApi {
   ...
   * ```
   */
  async approveCarriage(request: DeliveryFbsCarriageApproveRequest, options?: RequestOptions): Promise<DeliveryFbsCarriageApproveResponse> {
    return this.httpClient.request<DeliveryFbsCarriageApproveRequest, DeliveryFbsCarriageApproveResponse>("POST", "/v1/carriage/approve", request, options);
  }
   ...
   * ```
   */
  async cancelCarriage(request: DeliveryFbsCarriageCancelRequest, options?: RequestOptions): Promise<DeliveryFbsCarriageCancelResponse> {
    return this.httpClient.request<DeliveryFbsCarriageCancelRequest, DeliveryFbsCarriageCancelResponse>("POST", "/v1/carriage/cancel", request, options);
  }
   ...
   * ```
   */
  async createCarriage(request: DeliveryFbsCarriageCreateRequest, options?: RequestOptions): Promise<DeliveryFbsCarriageCreateResponse> {
    return this.httpClient.request<DeliveryFbsCarriageCreateRequest, DeliveryFbsCarriageCreateResponse>("POST", "/v1/carriage/create", request, options);
  }
   ...
   * ```
   */
  async getCarriageDeliveryList(request: DeliveryFbsCarriageDeliveryListRequest, options?: RequestOptions): Promise<DeliveryFbsCarriageDeliveryListResponse> {
    return this.httpClient.request<DeliveryFbsCarriageDeliveryListRequest, DeliveryFbsCarriageDeliveryListResponse>("POST", "/v1/carriage/delivery/list", request, options);
  }
   ...
   * ```
   */
  async getCarriage(request: DeliveryFbsCarriageGetRequest, options?: RequestOptions): Promise<DeliveryFbsCarriageGetResponse> {
    return this.httpClient.request<DeliveryFbsCarriageGetRequest, DeliveryFbsCarriageGetResponse>("POST", "/v1/carriage/get", request, options);
  }
   ...
   * ```
   */
  async setPostings(request: DeliveryFbsSetPostingsRequest, options?: RequestOptions): Promise<DeliveryFbsSetPostingsResponse> {
    return this.httpClient.request<DeliveryFbsSetPostingsRequest, DeliveryFbsSetPostingsResponse>("POST", "/v1/carriage/set-postings", request, options);
  }
   ...
   * ```
   */
  async getCarriageAvailableList(request: DeliveryFbsCarriageAvailableListRequest, options?: RequestOptions): Promise<DeliveryFbsCarriageAvailableListResponse> {
    return this.httpClient.request<DeliveryFbsCarriageAvailableListRequest, DeliveryFbsCarriageAvailableListResponse>("POST", "/v1/posting/carriage-available/list", request, options);
  }
   ...
   * ```
   */
  async splitPosting(request: DeliveryFbsPostingSplitRequest, options?: RequestOptions): Promise<DeliveryFbsPostingSplitResponse> {
    return this.httpClient.request<DeliveryFbsPostingSplitRequest, DeliveryFbsPostingSplitResponse>("POST", "/v1/posting/fbs/split", request, options);
  }
   ...
   * ```
   */
  async checkActStatus(request: DeliveryFbsActCheckStatusRequest, options?: RequestOptions): Promise<DeliveryFbsActCheckStatusResponse> {
    return this.httpClient.request<DeliveryFbsActCheckStatusRequest, DeliveryFbsActCheckStatusResponse>("POST", "/v2/posting/fbs/act/check-status", request, options);
  }
   ...
   * ```
   */
  async createAct(request: DeliveryFbsActCreateRequest, options?: RequestOptions): Promise<DeliveryFbsActCreateResponse> {
    return this.httpClient.request<DeliveryFbsActCreateRequest, DeliveryFbsActCreateResponse>("POST", "/v2/posting/fbs/act/create", request, options);
  }
   ...
   * ```
   */
  async getBarcode(request: DeliveryFbsGetBarcodeRequest, options?: RequestOptions): Promise<DeliveryFbsGetBarcodeResponse> {
    return this.httpClient.request<DeliveryFbsGetBarcodeRequest, DeliveryFbsGetBarcodeResponse>("POST", "/v2/posting/fbs/act/get-barcode", request, options);
  }
   ...
   * ```
   */
  async getBarcodeText(request: DeliveryFbsGetBarcodeRequest, options?: RequestOptions): Promise<DeliveryFbsGetBarcodeTextResponse> {
    return this.httpClient.request<DeliveryFbsGetBarcodeRequest, DeliveryFbsGetBarcodeTextResponse>("POST", "/v2/posting/fbs/act/get-barcode/text", request, options);
  }
   ...
   * ```
   */
  async getContainerLabels(request: DeliveryFbsGetContainerLabelsRequest, options?: RequestOptions): Promise<DeliveryFbsGetContainerLabelsResponse> {
    return this.httpClient.request<DeliveryFbsGetContainerLabelsRequest, DeliveryFbsGetContainerLabelsResponse>("POST", "/v2/posting/fbs/act/get-container-labels", request, options);
  }
   ...
   * ```
   */
  async getAct(request: DeliveryFbsGetActRequest, options?: RequestOptions): Promise<DeliveryFbsGetActResponse> {
    return this.httpClient.request<DeliveryFbsGetActRequest, DeliveryFbsGetActResponse>("POST", "/v2/posting/fbs/act/get-pdf", request, options);
  }
   ...
   * ```
   */
  async getActPostings(request: DeliveryFbsActGetPostingsRequest, options?: RequestOptions): Promise<DeliveryFbsActGetPostingsResponse> {
    return this.httpClient.request<DeliveryFbsActGetPostingsRequest, DeliveryFbsActGetPostingsResponse>("POST", "/v2/posting/fbs/act/get-postings", request, options);
  }
   ...
   * ```
   */
  async getActList(request: DeliveryFbsActListRequest, options?: RequestOptions): Promise<DeliveryFbsActListResponse> {
    return this.httpClient.request<DeliveryFbsActListRequest, DeliveryFbsActListResponse>("POST", "/v2/posting/fbs/act/list", request, options);
  }
   ...
   * ```
   */
  async checkDigitalActStatus(request: DeliveryFbsDigitalActCheckStatusRequest, options?: RequestOptions): Promise<DeliveryFbsDigitalActCheckStatusResponse> {
    return this.httpClient.request<DeliveryFbsDigitalActCheckStatusRequest, DeliveryFbsDigitalActCheckStatusResponse>("POST", "/v2/posting/fbs/digital/act/check-status", request, options);
  }
   ...
   * ```
   */
  async getDigitalAct(request: DeliveryFbsGetDigitalActRequest, options?: RequestOptions): Promise<DeliveryFbsGetDigitalActResponse> {
    return this.httpClient.request<DeliveryFbsGetDigitalActRequest, DeliveryFbsGetDigitalActResponse>("POST", "/v2/posting/fbs/digital/act/get-pdf", request, options);
  }
}
