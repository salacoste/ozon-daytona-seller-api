...
import type { 
  ReportFinanceCashFlowStatementListRequest,
  ReportCreateDiscountedRequest,
  ReportInfoRequest,
  ReportListRequest,
  ReportCreatePostingsRequest,
  ReportCreateProductsRequest,
  ReportCreateStockByWarehouseRequest,
  ReportCreateReturnsRequest
} from '../../types/requests/report.js';
import type { 
  ReportFinanceCashFlowStatementListResponse,
  ReportCreateDiscountedResponse,
  ReportInfoResponse,
  ReportListResponse,
  ReportCreateResponse,
  ReportCreateReturnsResponse
} from '../../types/responses/report.js';
...
export class ReportApi {
   ...
   * ```
   */
  async getFinanceCashFlowStatement(
    request: ReportFinanceCashFlowStatementListRequest,
    options?: RequestOptions
  ): Promise<ReportFinanceCashFlowStatementListResponse> {
    return this.httpClient.request<ReportFinanceCashFlowStatementListRequest, ReportFinanceCashFlowStatementListResponse>(
      'POST',
   ...
   * ```
   */
  async createDiscountedReport(
    request: ReportCreateDiscountedRequest,
    options?: RequestOptions
  ): Promise<ReportCreateDiscountedResponse> {
    return this.httpClient.request<ReportCreateDiscountedRequest, ReportCreateDiscountedResponse>(
      'POST',
  ...
  async getReportInfo(
    ...
    options?: RequestOptions
  ): Promise<ReportInfoResponse> {
    return this.httpClient.request<ReportInfoRequest, ReportInfoResponse>(
      'POST',
      '/v1/report/info',
      request,
      options
  ...
  async getReportList(
    ...
    return this.httpClient.request<ReportListRequest, ReportListResponse>(
      'POST',
      '/v1/report/list',
      request,
      options
  ...
  async createPostingsReport(
    request: ReportCreatePostingsRequest,
    options?: RequestOptions
  ): Promise<ReportCreateResponse> {
    return this.httpClient.request<ReportCreatePostingsRequest, ReportCreateResponse>(
      'POST',
  ...
  async createProductsReport(
    request: ReportCreateProductsRequest,
    options?: RequestOptions
  ): Promise<ReportCreateResponse> {
    return this.httpClient.request<ReportCreateProductsRequest, ReportCreateResponse>(
      'POST',
   ...
   * ```
   */
  async createStockByWarehouseReport(
    request: ReportCreateStockByWarehouseRequest,
    options?: RequestOptions
  ): Promise<ReportCreateResponse> {
    return this.httpClient.request<ReportCreateStockByWarehouseRequest, ReportCreateResponse>(
      'POST',
  ...
  async createReturnsReport(
    request: ReportCreateReturnsRequest,
    options?: RequestOptions
  ): Promise<ReportCreateReturnsResponse> {
    return this.httpClient.request<ReportCreateReturnsRequest, ReportCreateReturnsResponse>(
      'POST',
