...
export class RfbsReturnsApi {
   ...
   */
  async setAction(
    request: RfbsReturnsActionSetRequest,
    options?: RequestOptions
  ): Promise<RfbsReturnsActionSetResponse> {
   ...
   */
  async compensate(
    request: RfbsReturnsCompensateRequest,
    options?: RequestOptions
  ): Promise<RfbsReturnsEmptyResponse> {
    return this.httpClient.request<
      RfbsReturnsCompensateRequest,
      RfbsReturnsEmptyResponse
    >(
   ...
   */
  async getReturn(
    request: RfbsReturnsGetRequest,
    options?: RequestOptions
  ): Promise<RfbsReturnsGetResponse> {
    return this.httpClient.request<
      RfbsReturnsGetRequest,
      RfbsReturnsGetResponse
    >(
   ...
   * ```
   */
  async getReturnsList(
    request: RfbsReturnsListRequest,
    options?: RequestOptions
  ): Promise<RfbsReturnsListResponse> {
    return this.httpClient.request<
      RfbsReturnsListRequest,
      RfbsReturnsListResponse
    >(
   ...
   */
  async receiveReturn(
    request: RfbsReturnsReceiveReturnRequest,
    options?: RequestOptions
  ): Promise<RfbsReturnsEmptyResponse> {
    return this.httpClient.request<
      RfbsReturnsReceiveReturnRequest,
   ...
   */
  async reject(
    request: RfbsReturnsRejectRequest,
    options?: RequestOptions
  ): Promise<RfbsReturnsEmptyResponse> {
    return this.httpClient.request<
      RfbsReturnsRejectRequest,
   ...
   */
  async returnMoney(
    request: RfbsReturnsReturnMoneyRequest,
    options?: RequestOptions
  ): Promise<RfbsReturnsEmptyResponse> {
    return this.httpClient.request<
      RfbsReturnsReturnMoneyRequest,
   ...
   */
  async verify(
    request: RfbsReturnsVerifyRequest,
    options?: RequestOptions
  ): Promise<RfbsReturnsEmptyResponse> {
    return this.httpClient.request<
      RfbsReturnsVerifyRequest,
