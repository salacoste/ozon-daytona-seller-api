...
import type { BetaMethodAverageDeliveryTimeRequest, BetaMethodAverageDeliveryTimeDetailsRequest, BetaMethodManageStocksRequest, BetaMethodAnalyticsStocksRequest, BetaMethodProductInfoWrongVolumeRequest, BetaMethodRemovalReportRequest } from "../../types/requests/beta-method.js";
import type {
...
export class BetaMethodApi {
   ...
   * ```
   */
  async getAverageDeliveryTime(request: BetaMethodAverageDeliveryTimeRequest, options?: RequestOptions): Promise<BetaMethodAverageDeliveryTimeResponse> {
    return this.httpClient.request<BetaMethodAverageDeliveryTimeRequest, BetaMethodAverageDeliveryTimeResponse>("POST", "/v1/analytics/average-delivery-time", request, options);
  }
   ...
   * ```
   */
  async getAverageDeliveryTimeDetails(request: BetaMethodAverageDeliveryTimeDetailsRequest, options?: RequestOptions): Promise<BetaMethodAverageDeliveryTimeDetailsResponse> {
    return this.httpClient.request<BetaMethodAverageDeliveryTimeDetailsRequest, BetaMethodAverageDeliveryTimeDetailsResponse>("POST", "/v1/analytics/average-delivery-time/details", request, options);
  }
   ...
   * ```
   */
  async getAverageDeliveryTimeSummary(options?: RequestOptions): Promise<BetaMethodAverageDeliveryTimeSummaryResponse> {
    return this.httpClient.request<EmptyRequest, BetaMethodAverageDeliveryTimeSummaryResponse>("POST", "/v1/analytics/average-delivery-time/summary", undefined, options);
  }
   ...
   * ```
   */
  async getManageStocks(request: BetaMethodManageStocksRequest, options?: RequestOptions): Promise<BetaMethodManageStocksResponse> {
    return this.httpClient.request<BetaMethodManageStocksRequest, BetaMethodManageStocksResponse>("POST", "/v1/analytics/manage/stocks", request, options);
  }
   ...
   * ```
   */
  async getAnalyticsStocks(request: BetaMethodAnalyticsStocksRequest, options?: RequestOptions): Promise<BetaMethodAnalyticsStocksResponse> {
    return this.httpClient.request<BetaMethodAnalyticsStocksRequest, BetaMethodAnalyticsStocksResponse>("POST", "/v1/analytics/stocks", request, options);
  }
   ...
   * ```
   */
  async getProductsWithWrongVolume(request: BetaMethodProductInfoWrongVolumeRequest, options?: RequestOptions): Promise<BetaMethodProductInfoWrongVolumeResponse> {
    return this.httpClient.request<BetaMethodProductInfoWrongVolumeRequest, BetaMethodProductInfoWrongVolumeResponse>("POST", "/v1/product/info/wrong-volume", request, options);
  }
   ...
   * ```
   */
  async getRemovalFromStockReport(request: BetaMethodRemovalReportRequest, options?: RequestOptions): Promise<BetaMethodRemovalReportResponse> {
    return this.httpClient.request<BetaMethodRemovalReportRequest, BetaMethodRemovalReportResponse>("POST", "/v1/removal/from-stock/list", request, options);
  }
   ...
   * ```
   */
  async getRemovalFromSupplyReport(request: BetaMethodRemovalReportRequest, options?: RequestOptions): Promise<BetaMethodRemovalReportResponse> {
    return this.httpClient.request<BetaMethodRemovalReportRequest, BetaMethodRemovalReportResponse>("POST", "/v1/removal/from-supply/list", request, options);
  }
   ...
   * ```
   */
  async getRolesByToken(options?: RequestOptions): Promise<BetaMethodRolesByTokenResponse> {
    return this.httpClient.request<Record<string, never>, BetaMethodRolesByTokenResponse>("POST", "/v1/roles", {}, options);
  }
}
