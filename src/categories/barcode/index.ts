...
} from '../../types/requests/barcode.js';
import type { 
  BarcodeAddResponse,
  BarcodeGenerateResponse
} from '../../types/responses/barcode.js';
...
export class BarcodeApi {
  ...
  ): Promise<BarcodeAddResponse> {
    return this.httpClient.request<BarcodeAddRequest, BarcodeAddResponse>(
      'POST',
      '/v1/barcode/add',
      request,
      options
  ...
  async generateBarcodes(
    ...
    return this.httpClient.request<BarcodeGenerateRequest, BarcodeGenerateResponse>(
      'POST',
      '/v1/barcode/generate',
      request,
      options
