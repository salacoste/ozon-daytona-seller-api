...
export class QuantsApi {
   ...
   */
  async getInfo(
    request: QuantInfoRequest,
    options?: RequestOptions
  ): Promise<QuantInfoResponse> {
    return this.httpClient.request<QuantInfoRequest, QuantInfoResponse>(
      'POST',
   ...
   */
  async getList(
    request?: QuantListRequest,
    options?: RequestOptions
  ): Promise<QuantListResponse> {
    return this.httpClient.request<QuantListRequest, QuantListResponse>(
      'POST',
