...
exports.DeliveryFbsAPI = void 0;
const carriage_1 = require("./carriage");
const acts_1 = require("./acts");
const labels_1 = require("./labels");
const pdfs_1 = require("./pdfs");
class DeliveryFbsAPI {
    constructor(httpClient) {
        this.carriage = new carriage_1.DeliveryFbsCarriageManager(httpClient);
        this.acts = new acts_1.DeliveryFbsActsManager(httpClient);
        this.labels = new labels_1.DeliveryFbsLabelsManager(httpClient);
        this.pdfs = new pdfs_1.DeliveryFbsPdfsManager(httpClient);
    }
...
exports.DeliveryFbsAPI = DeliveryFbsAPI;
