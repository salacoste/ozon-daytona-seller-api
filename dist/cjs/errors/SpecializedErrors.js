...
exports.NetworkError = exports.ValidationError = exports.AuthError = exports.RateLimitError = void 0;
const OzonApiError_1 = require("./OzonApiError");
class RateLimitError extends OzonApiError_1.OzonApiError {
    constructor(options) {
        super({
...
class AuthError extends OzonApiError_1.OzonApiError {
    constructor(options) {
        super({
...
class ValidationError extends OzonApiError_1.OzonApiError {
    constructor(options) {
        super({
...
class NetworkError extends OzonApiError_1.OzonApiError {
    constructor(options) {
        super({
            httpStatus: 0,
            code: 0,
