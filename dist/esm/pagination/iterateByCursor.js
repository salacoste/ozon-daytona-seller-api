...
export async function* iterateByCursor(fetchPage, initialParams, config = {}) {
...
export async function collectByCursor(fetchPage, initialParams, config = {}) {
    const pages = [];
...
export async function collectItemsByCursor(fetchPage, initialParams, extractItems, config = {}) {
    const allItems = [];
    for await (const page of iterateByCursor(fetchPage, initialParams, config)) {
