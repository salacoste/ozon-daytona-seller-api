...
export async function* iterateByLastId(fetchPage, initialParams, config = {}) {
...
export async function collectByLastId(fetchPage, initialParams, config = {}) {
    const pages = [];
...
export async function collectItemsByLastId(fetchPage, initialParams, extractItems, config = {}) {
    const allItems = [];
    for await (const page of iterateByLastId(fetchPage, initialParams, config)) {
