...
export async function* iterateByOffset(fetchPage, initialParams, config = {}) {
...
export async function collectByOffset(fetchPage, initialParams, config = {}) {
    const pages = [];
...
export async function collectItemsByOffset(fetchPage, initialParams, extractItems, config = {}) {
    const allItems = [];
    for await (const page of iterateByOffset(fetchPage, initialParams, config)) {
